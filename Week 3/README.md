# BWSI Medlytics Course Material Week 3 - Medical Image Processing
...
## Reference Notebooks
- Contains notebooks for reference on using Keras, using multiple GPUs, pretrained models, and transfer learning.
