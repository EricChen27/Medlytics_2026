Please read this very carefully (every word), even if you are pretty familiar with these things. Why? we want to get everyone set up the same way and using the same toolset just to make things easier for sharing and helping each other. We appreciate your help with this. Also, if you think it can be improved (for eveyone) please feel free to share your ideas back with the instructors.
...
1. Open a terminal
2. Navigate to where you keep you want to work, e.g., type `mkdir my-classes` to make an empty directory for your coursework, then `cd my-classes` to move yourself there.
...
3. Go to the course GitHub repository page in your browser. Your instructor will give you the name/link.
4. Make a fork of the repo in your own GitHub account: click the `Fork` button and follow the instructions.
...
6. Open the README.md file (this file) and follow the instructions
...
**recommendation**: starting now, do all your python work using virtual environments. Never don't use them.
